...
1. **Direct connection** (preferred) - Traffic flows directly between your devices
2. **Relayed connection** (fallback) - If direct isn't possible, traffic goes through encrypted relay servers

Even with relayed connections, Kisuke relay servers **cannot decrypt your traffic**. They only forward encrypted packets.
