...
Once Kisuke Connect is installed and you sign in with the same account as your Kisuke app, your devices find each other automatically. No VPN, no port forwarding, no firewall rules required.
