...
graph TD
  A["Device A<br/>Can't reach B directly"] -->|Encrypted| Relay["Kisuke Relay<br/>Forwards encrypted packets<br/>between A and B"]
  B["Device B<br/>Can't reach A directly"] -->|Encrypted| Relay
```
...
See [Custom Infrastructure](/advanced/custom-infra) for details.
