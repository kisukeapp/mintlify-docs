...
If you're running on a VPS or a machine without a browser, use headless login to get an authentication link you can open on any device:

```bash
kisuke login --headless
```

This will output a URL — open it on any device, sign in, and the CLI will automatically detect the authentication.
