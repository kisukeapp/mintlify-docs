---
title: "Web Browser"
description: "Built-in browser with developer tools for testing and debugging"
---

## Overview

Kisuke includes a built-in web browser with developer tools for testing and debugging your web projects. Preview applications, inspect network requests, and test APIs—all from your mobile device.
