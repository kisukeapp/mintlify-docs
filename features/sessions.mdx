...
Click the current project name in the top left to open a dropdown. From there you can:

- **Open Project** — start a new project session
- **Switch** between any existing project sessions

This works the same on both desktop and mobile.
